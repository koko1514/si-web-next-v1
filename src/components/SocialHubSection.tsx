        ...
        <div className="flex flex-col items-center mb-16 space-y-8">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-2xl">
            ...
            <Button
              variant="outline"
              size="lg"
              className="group border-2 border-foreground/30 rounded-full px-5 sm:px-8 py-4 sm:py-6 text-xs sm:text-base font-semibold inline-flex items-center justify-center gap-2 hover:bg-secondary hover:text-secondary-foreground transition-all duration-300 w-full sm:w-auto h-auto min-h-[48px]"
              onClick={() => window.open(activeInstagramUrl, "_blank")}
            >
              <Instagram className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 text-foreground group-hover:text-secondary-foreground" />
              <span className="truncate max-w-[220px] sm:max-w-none">Follow @{activeUsername}</span>
              <ExternalLink className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 text-foreground group-hover:text-secondary-foreground" />
            </Button>
            ...
            {isDifferentFromMain && (
              <Button
                variant="outline"
                size="lg"
                className="group border-2 border-foreground/30 rounded-full px-4 sm:px-8 py-4 sm:py-6 text-xs sm:text-base font-semibold inline-flex items-center justify-center gap-2 hover:bg-secondary hover:text-secondary-foreground transition-all duration-300 w-full sm:w-auto h-auto min-h-[48px]"
                onClick={() => window.open("https://www.instagram.com/sistem.informasi.ithb/", "_blank")}
              >
                <Instagram className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 text-foreground group-hover:text-secondary-foreground" />
                <span className="text-center">Follow juga @sistem.informasi.ithb</span>
                <ExternalLink className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 text-foreground group-hover:text-secondary-foreground" />
              </Button>
            )}
          </div>
        ...
        <div className="columns-2 lg:columns-3 xl:columns-4 gap-3 sm:gap-6 space-y-3 sm:space-y-6">
          {posts.slice(0, visibleCount).map((post, idx) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="break-inside-avoid bg-card border border-border/80 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:border-pink-500/20 transition-colors duration-300 flex flex-col mb-3 sm:mb-6 cursor-default"
            >
              {/* Media Container */}
              <a
                href={post.permalink}
              ...
              >
                ...
                {post.media_type === "VIDEO" && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/10">
                    <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center text-white">
                      <Play className="w-4 h-4 sm:w-6 sm:h-6 fill-current ml-0.5" />
                    </div>
                  </div>
                )}
                {post.media_type === "CAROUSEL_ALBUM" && (
                  <div className="absolute top-2 right-2 sm:top-3 sm:right-3 w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-black/40 backdrop-blur-sm flex items-center justify-center text-white">
                    <Layers className="w-3 h-3 sm:w-4 sm:h-4" />
                  </div>
                )}
                
                {/* External link indicator */}
                <div className="absolute top-2 left-2 sm:top-3 sm:left-3 w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-black/40 backdrop-blur-sm flex items-center justify-center text-white opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
              ...
              <div className="p-3 sm:p-5 flex flex-col justify-between flex-grow">
                <div>
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-500 p-[1.5px] flex items-center justify-center shrink-0">
                  ...
                  {/* Caption */}
                  <div className="text-muted-foreground text-xs sm:text-sm leading-relaxed mb-3 sm:mb-5">
                ...
                {/* Card Footer */}
                <div className="pt-3 sm:pt-4 border-t border-border/60 flex items-center justify-between mt-auto">
                  <div className="flex items-center gap-1.5 sm:gap-2 overflow-hidden">
                    <Image
                      ...
                      width={24}
                      height={24}
                      className="w-5 h-5 sm:w-6 sm:h-6 rounded-full object-cover border border-border shrink-0"
                      onError={(e) => {
                    ...
                    <div className="flex flex-col min-w-0">
                      <span className="text-[9px] sm:text-[10px] font-bold text-foreground leading-none truncate">
                        @{post.username || "sistem.informasi.ithb"}
                      </span>
                  ...
                  <div className="shrink-0 ml-1">
                    <button
                      ...
                      className="w-6 h-6 sm:w-7 sm:h-7 rounded bg-muted hover:bg-secondary hover:text-secondary-foreground flex items-center justify-center text-muted-foreground transition-all duration-300 cursor-pointer"
